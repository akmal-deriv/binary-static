...
const Tac = () => (
    <div>
        ...
        <p>{it.L('We offer a number of merchant solutions and payment service providers for making online payments. You will be billed at the time of, or shortly after, making your transaction. You agree that you will pay for all trades that you purchase via any of the available merchant solutions or payment service providers. All sales of trades are final. We do not refund the price charged for entering a trade if the trade is executed.')}</p>
        <p>{it.L('If a trade becomes unavailable after the transaction is made but before the trade is executed, you may request a refund of the charged price. We reserve the right to accept or reject your request after investigating your claim. If technical problems prevent the execution of a trade, for example, if a disruption occurs in the data feeds that we cannot readily fix, we reserve the right to refund or reverse the trade.')}</p>
        <p>{it.L('Any request for a deposit refund for active accounts will be automatically rejected. If we have closed, blocked, or suspended your account (see the section on Fraud in General terms of use), you may request a refund of your deposit. We reserve the right to accept or reject your request after investigating your claim. ')}</p>
