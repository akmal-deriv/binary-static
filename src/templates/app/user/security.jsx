    ...
    <React.Fragment>
        <div className='invisible' id='settings_container'>
            ...
            <div className='gr-row gr-padding-30'>
                <Column id='change_password' dataShow='malta' url='change_passwordws' image='account_password' header={it.L('Account Password')} text={it.L('Change your Binary password.')} />

                <Column id='change_password' dataShow='-malta' url='change_passwordws' image='account_password' header={it.L('Account Password')} text={it.L('Change your Binary password and MT5 password.')} />
