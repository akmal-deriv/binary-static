                ...
                <div className='mt-panel'>
                    <div className='acc-actions'>
                        <a href='javascript:;' className='act_new_account new-account center-text invisible'>
                            <span data-show='-maltainvest'>{it.L('Create a MetaTrader 5 account')}</span>
                            <span data-show='maltainvest'>{it.L('Create a CFDs account')}</span>
                        </a>
                            ...
                            <div id='view_3' className='gr-row invisible'>
                                <div className='container gr-12'>
                                    <p id='trading_password_new_user' className='center-text notice-msg invisible'>
                                        <span data-show='-maltainvest'>{it.L('Create an MT5 password. You can use this password for all your MT5 accounts.')}</span>
                                        <span data-show='maltainvest'>{it.L('Create an MT5 password for logging in to your CFDs account.')}</span>
                                    </p>
